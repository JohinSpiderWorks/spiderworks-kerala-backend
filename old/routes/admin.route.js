...
}= require("../controller/menuManagement.controller")
...
//rely
router.put(
  "/dashboard/blogs/:id/comments/:comment_id/reply/:reply_id",
  updateReply
);
router.delete(
  "/dashboard/blogs/:id/comments/:comment_id/reply/:reply_id",
...
router.delete("/pages/:id/delete", deletePage);
...
router.post('/menus', createMenuManagement);

// Get all menus (add ?hierarchy=true for hierarchical structure)
router.get('/menus', getAllMenusManagement);

// Get single menu by ID
router.get('/menus/:id', getMenuManagementById);

// Update menu by ID
router.put('/menus/:id', updateMenuManagement);

// Delete menu by ID
router.delete('/menus/:id', deleteMenuManagement);
...
router.put(
  "/staticpage/:id/status",
  staticPageController.updateStaticPageStatus
);
